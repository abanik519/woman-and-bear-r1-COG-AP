                ...
                <div className="slide fade" style={{display: "flex"}}>
                    <div className="image-container">
                        ...
                        <div id="intro" className="speech sb1">
                          You will read the story "The Woman and her Bear." This story is a folktale told by the Inuit. A folktale is a traditional story that is passed down from one generation to another by word of mouth. Folktales usually explain something. Often folktales are a way for older people to teach young people how to behave in their local community. The Inuit homeland is known as Inuit Nunangat, meaning the land, ice, and water in the Artic regions that we call Alaska, Yukon, Northwest Territory, Nunavut including Baffin Island, and Greenland.  
                        </div>
                ...
                <div className="slide fade">
                    <div className="image-container">
                        ...
                        <div className="avatar-container">
                            ...
                            <p>One old woman lived alone. She had no husband and no sons to hunt or fish for her. Her neighbors shared their food with her but she was lonely. She longed for a family of her own. She often walked along the <span className='highlight'>shore</span>, looking far out to sea, praying that the gods might send her a son.</p>
                            <div id="s2" className="dictionary">
                            <span className='bold'>shore(noun):</span> The land along the edge of a sea, lake or other large body of water.
                            </div>
                        </div>
                    </div>
                </div>
